...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    public List<ForeignKey<ChatLinkRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CHAT_LINK__CHAT_LINK_LINK_ID_FKEY, Keys.CHAT_LINK__CHAT_LINK_CHAT_ID_FKEY);
    }
    ...
    public LinkPath link() {
        if (_link == null) {
            _link = new LinkPath(this, Keys.CHAT_LINK__CHAT_LINK_LINK_ID_FKEY, null);
        }
