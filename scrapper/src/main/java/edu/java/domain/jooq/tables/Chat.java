...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>public.chat.create_at</code>.
     */
    public final TableField<ChatRecord, OffsetDateTime> CREATE_AT = createField(DSL.name("create_at"),
    ...
    public ChatLinkPath chatLink() {
        if (_chatLink == null) {
            _chatLink = new ChatLinkPath(this, null, Keys.CHAT_LINK__CHAT_LINK_CHAT_ID_FKEY.getInverseKey());
        }
