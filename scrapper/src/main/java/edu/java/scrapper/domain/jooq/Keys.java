...
import edu.java.scrapper.domain.jooq.tables.Type;
...
public class Keys {
    ...
    public static final UniqueKey<TypeRecord> TYPE_PKEY =
        Internal.createUniqueKey(Type.TYPE, DSL.name("type_pkey"), new TableField[] {Type.TYPE.TYPE_}, true);
    ...
    public static final ForeignKey<LinkRecord, TypeRecord> LINK__FK_LINK_TYPE = Internal.createForeignKey(Link.LINK,
        DSL.name("fk_link_type"),
        new TableField[] {Link.LINK.TYPE},
        Keys.TYPE_PKEY,
        new TableField[] {Type.TYPE.TYPE_},
        true
    );
}
