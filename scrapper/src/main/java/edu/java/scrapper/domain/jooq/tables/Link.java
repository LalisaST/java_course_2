...
import edu.java.scrapper.domain.jooq.tables.Type.TypePath;
...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_UPDATE = createField(DSL.name("last_update"),
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_CHECK = createField(DSL.name("last_check"),
        SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false)
            .defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)),
        this,
        ""
    ...
    private transient TypePath _type;
    ...
    /**
     * Get the implicit join path to the <code>public.type</code> table.
     */
    public TypePath type() {
        if (_type == null) {
            _type = new TypePath(this, Keys.LINK__FK_LINK_TYPE, null);
        }
